...
describe('DankYou', () => {
  describe('When iterating with the answer Yes', () => {
    test('Should iterate properly', () => {
      ...
      expect(dankyou.next().value).toEqual(input.nodes[0])
      expect(dankyou.next().value).toEqual(input.nodes[1])
      expect(dankyou.next().value).toEqual(input.nodes[2])
      expect(dankyou.next('Yes').value).toEqual(input.nodes[4])
      expect(dankyou.next().value).toEqual(input.nodes[5])
  ...
  describe('When iterating with the answer No', () => {
    test('Should iterate properly', () => {
      ...
      expect(dankyou.next().value).toEqual(input.nodes[1])
      expect(dankyou.next().value).toEqual(input.nodes[2])
      expect(dankyou.next('No').value).toEqual(input.nodes[3])
      expect(dankyou.next().value).toEqual(input.nodes[5])
      expect(dankyou.next().value).toBe(undefined)
    })
  })
